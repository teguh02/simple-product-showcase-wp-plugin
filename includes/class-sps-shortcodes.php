...
class SPS_Shortcodes {
    ...
    public function register_shortcodes() {
        ...
        add_shortcode('sps_random_products', array($this, 'random_products_shortcode'));
    ...
    /**
     * Shortcode untuk menampilkan produk random
     * 
     * @param array $atts Attributes dari shortcode
     * @return string HTML output
     */
    public function random_products_shortcode($atts) {
        // Default attributes
        $atts = shortcode_atts(array(
            'columns' => '3',
            'limit' => '-1'
    ...
    public function products_sub_category_shortcode($atts) {
        ...
        // Validate columns - SAMA PERSIS seperti sps_products
        $columns = intval($atts['columns']);
        if ($columns < 1 || $columns > 6) {
            $columns = 3;
        }
